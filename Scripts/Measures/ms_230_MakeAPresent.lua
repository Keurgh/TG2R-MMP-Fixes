...
function Run()
	...
	-- Fajeth Mod
	local Amtmann = SimGetOfficeLevel("Destination")
	...
	-- Skill influence by Fajeth
	ProgressModify = ProgressModify + (GetSkillValue("", CHARISMA))
	FavorModify = FavorModify + (GetSkillValue("", CHARISMA))
